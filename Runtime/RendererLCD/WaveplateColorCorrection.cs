...
namespace Illumetry.Unity {
    public class WaveplateColorCorrection : MonoBehaviour {
        private const float _WL_R = 560; //650
        private const float _WL_G = 510; //530
        private const float _WL_B = 430; //460
        ...
        [Range(-180, 180)] public float ScreenPolarizationDeg = 0;
        [Range(-180, 180)] public float EyePolarizationAngleDeg = 90;
        [Range(-180, 180)] public float WaveplateAngleDeg = 45;
